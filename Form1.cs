...
namespace hajos_szabalyzat_excel
{
    public partial class Form1 : Form
    {
        ...
        "kép"};
            ...
            Excel.Range adatRange = xlSheet.get_Range("A1", Type.Missing).get_Resize(sorokSzáma, oszlopokSzáma);
            adatRange.Value2 = adatTömb;

            adatRange.Columns.AutoFit();

            Excel.Range fejllécRange = xlSheet.get_Range("A1", Type.Missing).get_Resize(1, 6);
            fejllécRange.Value2 = fejlécek;
